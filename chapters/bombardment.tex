...
Assuming non-ideal conditions, such as, an non perfect transfer on water and non-negligible of previous water  due to the impact. The amount of water accumulated will eventually reach the desired value of \(1.54\times 10^{22} kg\) but with significantly more cometary mass only if the amount of water escaping into space is less than the amount that is delivered.
...
Comets are bountiful objects of ice and dust that people throughout the ages admired or feared. They did deliver ice and other volatile elements to Earth through collisions.
There is enough cometary mass in the solar system to provide Earth the amount of water present on the Earth. 
...
The impacts would have caused massive amounts of rock dust and water vapor to enter the high atmosphere. The sub-micrometer dust cloud can severely block incoming light from the sun and cool the planet, and the water vapor may be photolyzed and be lost to space \cite{ImpactDust}. The dust cloud could help cool off the planet due to blocking the incoming solar radiation.
These effects of these impacts could be what was needed for the start of life.
